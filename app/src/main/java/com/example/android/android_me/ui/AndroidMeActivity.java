...
public class AndroidMeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        headFragment.setImageResourceId(AndroidImageAssets.getHeads());
        ...
        bodyFragment.setImageResourceId(AndroidImageAssets.getBodies());
        ...
        legFragment.setImageResourceId(AndroidImageAssets.getLegs());
        legFragment.setIndex(2);
        fragmentManager.beginTransaction()
