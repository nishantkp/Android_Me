...
public class BodyPartFragment extends Fragment {
    ...
    private static final String KEY_IMAGE_RESOURCE = "image-resource-ids";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            mImageIds = savedInstanceState.getIntegerArrayList(KEY_IMAGE_RESOURCE);
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putIntegerArrayList(KEY_IMAGE_RESOURCE, (ArrayList<Integer>) mImageIds);
